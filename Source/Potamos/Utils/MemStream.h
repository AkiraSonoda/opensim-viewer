...
public:
	...
	static size_t inline read(void* buf, size_t len, void* me) {
		return ((MemStream*)me)->read(buf, len);
	}

	static OPJ_OFF_T inline skip(OPJ_OFF_T len, void* me) {
		return ((MemStream*)me)->_skip(len);
	}

	static OPJ_BOOL inline seek(OPJ_OFF_T pos, void* me) {
		return ((MemStream*)me)->_seek(pos);
	}
