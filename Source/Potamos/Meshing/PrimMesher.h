...
public:
	...
	Profile();
	Profile(int sides, float profileStart, float profileEnd, float hollow, int hollowSides, bool createFaces,
...
public:
	...
	inline void ExtrudeLinear() {
		Extrude(Linear);
	}

	inline void ExtrudeCircular() {
		Extrude(Circular);
	}
