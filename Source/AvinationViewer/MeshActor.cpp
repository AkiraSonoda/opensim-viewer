...
AMeshActor::AMeshActor() {
	...
	ConstructorHelpers::FObjectFinder<UMaterial> parentMaterial(
		TEXT("Material'/Game/Materials/DynamicBase.DynamicBase'"));

	baseMaterial = parentMaterial.Object;

	ConstructorHelpers::FObjectFinder<UMaterial> parentMaterialTranslucent(
		TEXT("Material'/Game/Materials/DynamicBaseTranslucent.DynamicBaseTranslucent'"));

	baseMaterialTranslucent = parentMaterialTranslucent.Object;

	ConstructorHelpers::FObjectFinder<UMaterial> parentMaterialUnLit(
		TEXT("Material'/Game/Materials/DynamicBaseUnLit.DynamicBaseUnLit'"));

	baseMaterialUnLit = parentMaterialUnLit.Object;

	ConstructorHelpers::FObjectFinder<UMaterial> parentMaterialTranslucentUnLit(
		TEXT("Material'/Game/Materials/DynamicBaseTranslucentUnLit.DynamicBaseTranslucentUnLit'"));
...
UMaterialInstanceDynamic* AMeshActor::SetUpMaterial(UProceduralMeshComponent* mesh, int textureIndex, UMaterial* bMat,
                                                    TextureEntry& te) {
...
UMaterialInstanceDynamic* AMeshActor::SetUpMaterialUnLit(UProceduralMeshComponent* mesh, int textureIndex,
                                                         UMaterial* bMat, TextureEntry& te) {
	//if (baseMat == baseMaterialTranslucent)
	//    UE_LOG(LogTemp, Warning, TEXT("Translucent texture"));
...
void AMeshActor::GotTexture(FGuid id, TSharedAssetRef asset, UProceduralMeshComponent* mesh, int index,
                            TextureEntry* te) {
